              ...
              <div className="p-4 sm:p-7 rounded-xl bg-zinc-900/50 border border-zinc-800">
                      ...
                      >
                        ...
                        <div className="flex flex-wrap gap-1.5">
                          {project.technologies.map((tech) => (
                            <span
                              key={tech}
                              className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded bg-zinc-900 border border-zinc-800 text-[11px] font-mono text-zinc-300"
                            >
                              <TechIcon name={tech} className="w-3 h-3 text-zinc-400 shrink-0" />
                              <span>{tech}</span>
                            </span>
                          ))}
                        </div>
                ...
                <div className="mt-5 pt-3.5 border-t border-zinc-800 flex flex-wrap items-center gap-1.5">
                  ...
                  {exp.technologies.map((tech) => (
                    <span
                      key={tech}
                      className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded bg-zinc-800 border border-zinc-700/60 text-xs text-zinc-300 font-mono"
                    >
                      <TechIcon name={tech} className="w-3.5 h-3.5 text-zinc-400 shrink-0" />
                      <span>{tech}</span>
                    </span>
                  ))}
                </div>
